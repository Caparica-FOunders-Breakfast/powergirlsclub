...
export const weeklyPlan: WorkoutDay[] = [
  ...
  },
  {
    ...
    isRest: false,
    exercises: [
      { name: "Lat Pulldown", sets: 3, reps: "10", suggestedWeight: "25–35 kg", progression: "+2 to 2.5 kg" },
      ...
      { name: "Push Ups", sets: 3, reps: "10", suggestedWeight: "Bodyweight", progression: "Add reps", isBodyweight: true },
      { name: "Dead Bug", sets: 3, reps: "10", suggestedWeight: "Bodyweight", progression: "Slow controlled movement", isBodyweight: true },
